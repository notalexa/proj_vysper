...
public class ServerResponses {
    ...
    public Stanza getFeaturesForAuthentication(List<SASLMechanism> authenticationMethods) {
    	return getFeaturesForAuthentication(authenticationMethods,false);
    }
    
    public Stanza getFeaturesForAuthentication(List<SASLMechanism> authenticationMethods,boolean includeStartTLS) {
        StanzaBuilder stanzaBuilder = startFeatureStanza();
        ...
        stanzaBuilder.endInnerElement();
        if(includeStartTLS) {
        	stanzaBuilder.startInnerElement("starttls",NamespaceURIs.URN_IETF_PARAMS_XML_NS_XMPP_TLS).endInnerElement();
        }
        return stanzaBuilder.build();
    }
