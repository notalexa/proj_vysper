...
public class InboundStanzaProtocolWorker extends AbstractStateAwareProtocolWorker {
	...
	public void processStanza(SessionContext sessionContext, SessionStateHolder sessionStateHolder, Stanza stanza,
		...
		sessionContext.getResponseWriter().write(stanza);		// TODO Auto-generated method stub
//		super.processStanza(sessionContext, sessionStateHolder, stanza, stanzaHandler);
	}
