...
public class DiscoInfoIQHandler extends DefaultIQHandler {
    ...
    protected Stanza handleGet(IQStanza stanza, ServerRuntimeContext serverRuntimeContext, SessionContext sessionContext) {
        ...
        if(serverRuntimeContext!=serverRuntimeContext.getDomainContext()) {
        	// TODO Remove this hack. Evaluate disco info on the component context directly
        	serverRuntimeContext=serverRuntimeContext.getDomainContext();
        }
        ...
        try {
            ...
            if (isServerInfoRequest) {
            	...
            	InfoRequest request=new InfoRequest(from,to,node,stanza.getID());
                elements = serviceCollector.processComponentInfoRequest(request);
