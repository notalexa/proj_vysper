...
public interface DeliveryFailureStrategy {
	public static DeliveryFailureStrategy IGNORE=new DeliveryFailureStrategy() {
		@Override
	...
	public static DeliveryFailureStrategy RETURN_TO_SENDER=new ReturnErrorToSenderFailureStrategy();
     ...
     */
    public void process(StanzaRelay relay,Stanza failedToDeliverStanza, List<DeliveryException> deliveryException)
