...
public interface SessionContext {
    ...
    default ServerRuntimeContext resolveDomainContext(Stanza stanza) {
    	Entity to=stanza.getTo();
    	return to==null?getServerRuntimeContext():getServerRuntimeContext().resolveDomainContext(to);
    }
    
    default String getSessionNamespaceURI() {
    	return isServerToServer()?NamespaceURIs.JABBER_SERVER:NamespaceURIs.JABBER_CLIENT;
    }
