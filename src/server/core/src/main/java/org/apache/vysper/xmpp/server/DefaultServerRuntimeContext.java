...
public class DefaultServerRuntimeContext implements ServerRuntimeContext, ModuleRegistry {
    ...
    public DefaultServerRuntimeContext(Entity serverEntity, ServerRuntimeContextProvider contextProvider, StanzaRelay stanzaRelay, ServerFeatures serverFeatures,
            List<HandlerDictionary> dictionaries, ResourceRegistry resourceRegistry) {
    	stanzaHandlerLookup=new StanzaHandlerLookup(this);
    ...
    public void registerComponent(Component component) {
    	contextProvider.add(component.getComponentContext());
	...
	public Component getComponent(String subdomain) {
		return componentMap.get(subdomain);
	}

	@Override
	public ServerRuntimeContext resolveDomainContext(Entity entity) {
		return contextProvider.resolveDomainContext(entity);
	}
}
