...
public class ReturnErrorToSenderFailureStrategy implements DeliveryFailureStrategy {
    ...
    public ReturnErrorToSenderFailureStrategy() {
    }
    ...
    public void process(StanzaRelay relay,Stanza failedToDeliverStanza, List<DeliveryException> deliveryExceptions)
        ...
        if (deliveryExceptions == null) {
            ...
            relay.relay(error.getTo(), error, DeliveryFailureStrategy.IGNORE);
            ...
            if (deliveryException instanceof LocalRecipientOfflineException) {
                ...
                if (failedCoreStanza instanceof PresenceStanza) {
                    ...
                    if (presenceStanzaType == SUBSCRIBE) {
                        ...
                        relay.relay(to, finalStanza, DeliveryFailureStrategy.IGNORE);
                        return;
                    }
                }
