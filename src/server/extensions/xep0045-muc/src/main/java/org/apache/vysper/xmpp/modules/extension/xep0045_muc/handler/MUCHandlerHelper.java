...
public class MUCHandlerHelper {
    ...
    public static Stanza createErrorReply(Entity from,Stanza originalStanza, StanzaErrorType type, StanzaErrorCondition error) {
        ...
        builder.addAttribute("to", from.getFullQualifiedName());
