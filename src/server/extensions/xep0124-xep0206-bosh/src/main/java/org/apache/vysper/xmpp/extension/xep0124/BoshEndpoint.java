 ...
 */
public class BoshEndpoint implements MultiHostEndpoint {
     ...
     * @return
     */
    protected Handler createHandler(ServerRuntimeContextProvider contextProvider) {
        ...
        boshServlet.setServerRuntimeContextProvider(contextProvider);
    ...
    public void start(ServerRuntimeContextProvider contextProvider) throws IOException {
        ...
        Handler handler = createHandler(contextProvider);
